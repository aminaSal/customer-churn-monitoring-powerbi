...
This project presents an interactive dashboard analyzing customer churn behavior using the Telco dataset. The objective is to identify key drivers of churn and provide actionable insights to improve customer retention.
...
1. Customer Tenure and Churn Behavior
- Average tenure (Churners): 17.98 months
- Average tenure (Non-churners): 37.57 months
2. High Churn Rate Indicates Structural Retention Issues
...
Provide incentives to convert month-to-month users into annual or multi-year plans.
### Improve Customer Onboarding
Focus on the first months of the customer journey to reduce early churn.
### Optimize Pricing Strategy
Reassess pricing for high-paying customers to ensure perceived value aligns with cost.
...
Churn in this dataset is primarily driven by lack of contractual commitment and early-stage disengagement.
Improving retention requires a combination of:
- stronger customer engagement strategies,
- better onboarding experiences,
- and incentives for long-term commitment.
